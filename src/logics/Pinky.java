...
/**
 * This class is for the pink ghost. It keeps the ghost position, speed etc. We
 * have created methods so the ghost can move, change to scared mode and collide
 * with the player. The pink ghost changes direction randomly when hitting a
...
public class Pinky extends Ghosts {
	...
	public Pinky() {
		super();
		try {
			this.normalGraphic = new Image(new FileInputStream("pinky.png"), SCREEN_WIDTH / 30, SCREEN_HEIGHT / 30,
					false, false);
